...
RSpec.describe Food, type: :model do
  before(:each) do
    ...
    User.destroy_all
    @user = User.create!(name: 'johnson', email: 'johnsonnifemi8@gmail.com', password: '123456')
    @food = Food.create!(name: 'rice', measurement: 'gram', quantity: 2, price: 1, user_id: @user.id)
  end
